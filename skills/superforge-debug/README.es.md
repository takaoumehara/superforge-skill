...
MIT — consulta [LICENSE](../../LICENSE). El protocolo de cuatro fases y las llamadas exactas a `failforward` están en [SKILL.md](SKILL.md). Visión general de la suite: [superforge-skill](../../README.md).
