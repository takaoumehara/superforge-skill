...
### ⏳ 売っているのが稼働なら、天井は算数で出る
プロダクトの天井は市場だが、サービス業の天井は 稼働可能時間 × 単価 × 稼働率 で、感覚より低い。そして実際の成果物は、スコープを書いた一文のほう——成果物・修正回数・含まれないもの・**そして終わりの条件**。終わりが定義されていない案件は終わらないからだ。損失の最大要因は安売りではなくスコープクリープで、売上の50%を超える一社は顧客ではなく雇用主。
